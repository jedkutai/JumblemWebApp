...
interface VStackProps {
    /** 
     * The content to be displayed inside the vertical stack. 
     ...
     * - `"stretch"`: Stretch items to fill the container's width.
 ...
 */
export function VStack({children, alignment, spacing, padding, width, height, maxWidth, maxHeight, minWidth, minHeight, backgroundColor, border, cornerRadius,}: VStackProps) {
