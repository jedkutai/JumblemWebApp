...
export function Button({children, action, color, fontSize, fontWeight, padding, width, height, maxWidth, maxHeight, minWidth, minHeight, backgroundColor, border, cornerRadius,}: ButtonProps) {
